module IslayShop::Public::PromotionDisplayHelper
  def promo_code_response(result, form_builder = nil)
    ...
    case result
    when :invalid_code
      response << form_builder.input(:promo_code, :label => 'That wasn\'t a valid offer code. Try again?', :input_html => {:class => 'code', :placeholder => 'Offer Code' })
    ...
    when :did_not_qualify
      ...
      if result and form_builder.object.new_promotions?
